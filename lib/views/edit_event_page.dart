...
class EditEventPage extends StatefulWidget {
  final String name, desc, loc, datetime, guests, sponsers, docID;
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child:
            ...
            //         color: kLightPurple, borderRadius: BorderRadius.circular(8)),
            ...
            Row(
              children: [
                ...
                Switch(
                    ...
                    focusColor: Color.fromARGB(255, 157, 70, 211),
            ...
            SizedBox(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                try {
                  final String response = await updateEvent(
